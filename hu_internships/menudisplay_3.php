...
<head>
    ...
    <title>Home - HU Internship System</title>
...
<nav class="navbar navbar-expand-lg sticky-top">
  <div class="container">
    <a class="navbar-brand" href="#home fw-bold">HU Internship System</a>
...
<div class="container mt-4">
    ...
    <div class="hero mb-5" id="home">
        <h2 class="fw-bold">Welcome to Internship System, <?php echo $_SESSION["username"]; ?></h2>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="card-modern">
                    ...
                    <h6>เปิดรับสมัครนิสิตเข้าร่วมโครงการ TKU's Japan Study Program (JSP) 2026</h6>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card-modern">
        ...
        <div class="row g-3">
            <div class="col-md-3">
                <div class="card-modern text-center">
                    ...
                    <p class="small">ปรับพื้นฐานความรู้ด้านสารสนเทศและการใช้เทคโนโลยีเบื้องต้น</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card-modern text-center">
                    <h5 class="fw-bold text-danger">ปี 2</h5>
                    <p class="small">เจาะลึกวิชาเฉพาะทาง ระบบฐานข้อมูล และการคิดวิเคราะห์</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card-modern text-center">
                    <h5 class="fw-bold text-danger">ปี 3</h5>
                    <p class="small">พัฒนาทักษะเชิงลึก การออกแบบระบบ และเตรียมความพร้อมฝึกงาน</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card-modern text-center">
                    <h5 class="fw-bold text-danger">ปี 4</h5>
                    <p class="small">ฝึกปฏิบัติงานจริงในสถานประกอบการและจัดทำโครงงานวิจัย</p>
                </div>
            </div>
        </div>
    </div>
   ...
   ?>
    ...
    <div class="text-center mb-5">
        <a href="contact.php" class="btn btn-outline-danger px-4 py-2" style="border-radius: 30px;">
